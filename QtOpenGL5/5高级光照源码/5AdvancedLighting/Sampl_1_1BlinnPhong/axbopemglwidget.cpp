...
void AXBOpemglWidget::paintGL()
{
    ...
    m_ShaderProgram.setUniformValue("light.ambient", 0.2f, 0.2f, 0.2f);
    m_ShaderProgram.setUniformValue("light.diffuse", 0.5f, 0.5f, 0.5f);
    ...
    m_ShaderProgram.setUniformValue("blinn", blinn);

    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->checkBoxHDR,SIGNAL(clicked(bool)),ui->openGLWidget,SLOT(setHDR(bool)));
    connect(ui->SpinBoxExposure,SIGNAL(valueChanged(double)),ui->openGLWidget,SLOT(setExposure(double)));
}

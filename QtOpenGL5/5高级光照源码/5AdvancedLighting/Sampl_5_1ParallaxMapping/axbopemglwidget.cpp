...
void AXBOpemglWidget::initializeGL()
{
    ...
    m_PlaneDiffuseTex=new QOpenGLTexture(QImage(":/images/images/bricks2.jpg").mirrored());
    m_PlaneNormalTex=new QOpenGLTexture(QImage(":/images/images/bricks2_normal.jpg").mirrored());
    m_PlaneHeightTex=new QOpenGLTexture(QImage(":/images/images/bricks2_disp.jpg").mirrored());

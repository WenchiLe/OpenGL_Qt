...
AXBOpemglWidget::AXBOpemglWidget(QWidget *parent) : QOpenGLWidget(parent)
{
    ...
    windows.push_back(QVector3D(-1.5f, 0.5f, -0.48f));
    windows.push_back(QVector3D( 1.5f, 0.5f, 0.51f));
    windows.push_back(QVector3D( 0.0f, 0.5f, 0.7f));
    windows.push_back(QVector3D(-0.3f, 0.5f, -2.3f));
    windows.push_back(QVector3D( 0.5f, 0.5f, -0.6f));

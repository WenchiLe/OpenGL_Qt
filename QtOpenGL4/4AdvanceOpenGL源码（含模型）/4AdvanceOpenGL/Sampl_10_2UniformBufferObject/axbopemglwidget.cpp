...
void AXBOpemglWidget::initializeGL()
{
 ...
 //   m_CubeMap->setWrapMode(QOpenGLTexture::DirectionR, QOpenGLTexture::ClampToEdge);
    ...
    int uniformBlockIndexShader = glGetUniformBlockIndex(m_ShaderProgram.programId(),"Matrices");
    int uniformBlockIndexSkyBoxShader = glGetUniformBlockIndex(m_SkyBoxShaderProgram.programId(),"Matrices");
    glUniformBlockBinding(m_ShaderProgram.programId(), uniformBlockIndexShader, 0);
    glUniformBlockBinding(m_SkyBoxShaderProgram.programId(),uniformBlockIndexSkyBoxShader, 0);

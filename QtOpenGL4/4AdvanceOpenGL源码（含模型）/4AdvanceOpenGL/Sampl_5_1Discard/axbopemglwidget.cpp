...
void AXBOpemglWidget::initializeGL()
{
    ...
    m_GrassDiffuseTex=new
            QOpenGLTexture(QImage(":/images/images/grass.png"));
    ...
    m_GrassMesh=processMesh(transparentVertices,6,m_GrassDiffuseTex->textureId());
}
...
void AXBOpemglWidget::paintGL()
{
    ...
    foreach (auto item, vegetation) {
        ...
        m_ShaderProgram.setUniformValue("model", model);
        m_GrassMesh->Draw(m_ShaderProgram);
    }
